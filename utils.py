...
def get_training_recommendations(gender, age_category, goal):
    """
    Возвращает рекомендации по тренировкам для мужчин и женщин,
    с учетом возрастной категории и фитнес-цели.
    Рекомендации включают описание и список тренировочных программ.
    """
    recommendations = {}
